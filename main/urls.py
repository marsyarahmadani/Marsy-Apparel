...
from main.views import register, login_user, logout_user, delete_product, increment_product, decrement_product,edit_product, get_product_json, add_product_ajax, delete_product_ajax
